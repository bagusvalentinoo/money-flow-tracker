...
/* harmony import */ var sweetalert2__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(sweetalert2__WEBPACK_IMPORTED_MODULE_1__);
    ...
    document.getElementById('basic').addEventListener('click', function (e) {
      sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire('Any fool can use a computer');
    });
    ...
    document.getElementById('title').addEventListener('click', function (e) {
      sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire('The Internet?', 'That thing is still around?', 'question');
    });
    ...
    document.getElementById('email').addEventListener('click', /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(e) {
        var _yield$Swal$fire, email;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                if (email) {
                  sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire("Entered email: ".concat(email));
                }
    ...
    document.getElementById('url').addEventListener('click', /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2(e) {
        var _yield$Swal$fire2, url;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                if (url) {
                  sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire("Entered URL: ".concat(url));
                }
    ...
    document.getElementById('password').addEventListener('click', /*#__PURE__*/function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee3(e) {
        var _yield$Swal$fire3, password;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                _yield$Swal$fire3 = _context3.sent;
                password = _yield$Swal$fire3.value;

                if (password) {
                  sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire("Entered password: ".concat(password));
                }
    ...
    document.getElementById('textarea').addEventListener('click', /*#__PURE__*/function () {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 2:
                _yield$Swal$fire4 = _context4.sent;
                text = _yield$Swal$fire4.value;

                if (text) {
                  sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire(text);
                }
    ...
    document.getElementById('select').addEventListener('click', /*#__PURE__*/function () {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 2:
                _yield$Swal$fire5 = _context5.sent;
                fruit = _yield$Swal$fire5.value;

                if (fruit) {
                  sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire("You selected: ".concat(fruit));
                }
